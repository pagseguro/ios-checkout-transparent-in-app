...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = [UIColor clearColor];//[UIColor colorWithRed:115.0f/255.f green:184.0f/255.0f blue:67.0f/255.0f alpha:1.0f];
		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
		self.detailsLabelColor = [UIColor whiteColor];
        self.activityIndicatorColor = UIColorFromHex(0x49872F);
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
		...
		self.opaque = NO;
		self.backgroundColor = [UIColor colorWithWhite:0.90f alpha:0.8f];
...
- (void)updateIndicators {
	...
	BOOL isActivityIndicator = [indicator isKindOfClass:[AMPActivityIndicator class]];
	...
	if (mode == MBProgressHUDModeIndeterminate) {
		if (!isActivityIndicator) {
			...
			self.indicator = MB_AUTORELEASE([[AMPActivityIndicator alloc] init]);
//            [(YRActivityIndicator *)self.indicator setCycleDuration:2];
//            [(YRActivityIndicator *)self.indicator setMinItemSize:(CGSize){5, 5}];
//            [(YRActivityIndicator *)self.indicator  setMaxItemSize:(CGSize){20, 20}];
//            [(YRActivityIndicator *)self.indicator setMaxItems:6];
//            [(YRActivityIndicator *)self.indicator setMaxSpeed:1.6];
//            [(YRActivityIndicator *)self.indicator setRadius:30];
            
//            self.indicator.frame = CGRectMake(0, 0, 70, 70);
			[self addSubview:indicator];
            
            [(AMPActivityIndicator *)indicator startAnimating];
		}
        [(AMPActivityIndicator*)indicator setBarColor:self.activityIndicatorColor];
//        [(YRActivityIndicator *)indicator setItemColor:self.activityIndicatorColor];
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 50000
//		[(YRActivityIndicator *)indicator setColor:self.activityIndicatorColor];
#endif
	}
